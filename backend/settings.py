...
ALLOWED_HOSTS = ['3.15.49.217', 'localhost', '127.0.0.1']
...
JAZZMIN_SETTINGS = {
    "site_title": "Kubelik LMS Admin",
    "site_header": "Kubelik LMS",
    "site_brand": "Kubelik LMS",
    #"site_logo": "static/img/logo.png",
    "welcome_sign": "Welcome Kubelik LMS",
    "copyright": "Kubelik Ltd",
